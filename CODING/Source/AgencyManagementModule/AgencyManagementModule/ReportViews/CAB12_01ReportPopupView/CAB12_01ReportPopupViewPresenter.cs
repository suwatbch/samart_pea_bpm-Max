...
{
    public class CAB12_01ReportPopupViewPresenter : Presenter<ICAB12_01ReportPopupView>
    {
        /// <summary>
        ...
        [EventPublication(EventTopicNames.ShowCAB12_01Report, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs> LoadCAB12_01ReportHandler;
        public void ShowCAB12_01Clicked(CAB12_01ConditionReportInfo conn)
        {
            if (LoadCAB12_01ReportHandler != null)
                LoadCAB12_01ReportHandler(this, new EventArgs<CAB12_01ConditionReportInfo>(conn));
        }
