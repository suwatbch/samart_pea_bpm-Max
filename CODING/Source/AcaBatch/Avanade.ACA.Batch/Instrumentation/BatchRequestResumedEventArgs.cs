...
{
    /// <summary>
    /// Summary for BatchRequestResumedEventArgs class
    /// </summary>
    public class BatchRequestResumedEventArgs : EventArgs
    {
        ...
        public BatchRequestResumedEventArgs(Guid requestKey, string requestName)
        {
