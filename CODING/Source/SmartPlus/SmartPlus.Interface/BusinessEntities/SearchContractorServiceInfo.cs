...
{
    [DataContract]
    public class  ARInformationInfo
    {
        ...
        private decimal _vatRate;           // NEED TO CHANGE TO STRING TYPE
        ...
        private string _installmentPeriodText;
        private string _remark;                     //32
        private string _RefInvoiceNo;
        private string _RefWSKey;
        ...
        {
            get { return this._fullGAmount; }
            set { this._fullGAmount = value; }
        }
        ...
        [DataMember(Order = 36)]
        public string InstallmentPeriodText
        {
            get { return this._installmentPeriodText; }
            set { this._installmentPeriodText = value; }
        }
        ...
        {
          get { return this._RefInvoiceNo;  }
          set { this._RefInvoiceNo = value; }
        }

        [DataMember(Order = 39)]
        public string RefWSKey
        {
          get { return this._RefWSKey;    }
          set { this._RefWSKey = value;   }
        }
    }
}
