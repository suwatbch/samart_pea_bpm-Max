...
{
    public class DL009_EXPORT_RECON_JOB : IJob
    {
        private const string DL_FULL_NAME = "DL009_EXPORT_RECON_JOB";
        ...
        public void Execute(JobExecutionContext context)
        {
            ...
            string ssuggt = "รายการรับชำระเงินค่าไฟฟ้าและค่าต่อกลับ";
            ...
            {
                _logger.InterfaceId = INTERFACE_NAME;
