...
{
    public class ARn_APPayment : IListUtility<ARn_APPayment>
    {
        string _action;
        string _posRSG;
        string _ptId;
        ...
        public string ToStream()
        {
            ...
            string[] template = { Action == null ? string.Empty : Action, 
                                    ...
                                    InvoiceNo  == null ? string.Empty : InvoiceNo.IndexOf("---") < 0 ? InvoiceNo : InvoiceNo.Substring(0, InvoiceNo.IndexOf("---")), 
                                    ...
                                    MainSub == null ? string.Empty : MainSub, 
        ...
        public ARn_APPayment ParseExtract(string txt)
        {
