...
{
    public class AP_BankPayIn : IListUtility<AP_BankPayIn>
    {
        string _action;
        string _posRSG;
        string _ptId;
        ...
        {
            get { return this._glAccountNo; }
            set { this._glAccountNo = value; }
        }
        ...
        #region IListUtility<AP_BankPayIn> Members
        ...
        public string ToStream()
        {
            ...
            string[] template = { Action == null ? string.Empty : Action, 
                                    ...
                                    GLAccountNo == null ? string.Empty : GLAccountNo,
        ...
        public AP_BankPayIn ParseExtract(string txt)
        {
