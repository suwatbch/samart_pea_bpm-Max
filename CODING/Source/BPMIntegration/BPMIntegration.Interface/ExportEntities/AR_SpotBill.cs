...
{
    public class AR_SpotBill : IListUtility<AR_SpotBill>
    {
        string _action;
        string _posRSG;
        string _ptId;
        ...
        {
            get { return this._notificationNo; }
            set { this._notificationNo = value; }

        }

        #region IListUtility<AR_SpotBill> Members
        ...
        public string ToStream()
        {
            ...
            string[] template = { Action == null ? string.Empty : Action, 
                                    ...
                                    NotificationNo == null ? string.Empty : NotificationNo };   
            return string.Join("|", template);
        }

        public AR_SpotBill ParseExtract(string txt)
        {
