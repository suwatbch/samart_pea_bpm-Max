...
namespace PEA.BPM.BPMGatewayService
{
    public class BillingWrapper
    {
        ...
        public List<InvoiceInfo> SearchInvoiceByCustomerId(string contractAccount)
        {
            ...
            else if (contractAccount == "020000002065" || contractAccount == "20000002065")
            {
                InvoiceInfo info = new InvoiceInfo();
                info.ContractAccountAddress = "เลขที่ 89/126 ม.9 ต.คลองสอง อ.คลองหลวง จ.ปทุมธานี 12120";
                info.ContractAccountId = "020000002065";
                info.ContractAccountName = "นาย อาหลง  แสงบุญ";
                info.InvoicePeriod = "03/2555";
                info.PaymentDueDate = "09/05/2555";
                info.ToPayTotalAmount = Convert.ToDecimal(507.40);
                info.DebtTypeName = "ค่าไฟฟ้า";
                invoiceList.Add(info);
            }
            else if (contractAccount == "020004277857" || contractAccount == "020004277857")
            {
                InvoiceInfo info = new InvoiceInfo();
                info.ContractAccountAddress = "เลขที่ 134 ม.7 ต.บางขุนไทร อ.บ้านแหลม จ.เพชรบุรี 76110";
                info.ContractAccountId = "020004277857";
                info.ContractAccountName = "นาย บุญชู  รุ่งสว่าง";
                info.InvoicePeriod = "04/2555";
                info.PaymentDueDate = "08/05/2555";
                info.ToPayTotalAmount = Convert.ToDecimal(1521.69);
                info.DebtTypeName = "ค่าไฟฟ้า";
                invoiceList.Add(info);
            }
