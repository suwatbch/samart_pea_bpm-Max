...
{
    public class RE_05CriteriaViewPresenter : Presenter<IRE_05CriteriaView>
    {
        ...
        [EventPublication(EventTopicNames.RE_05Report, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs<RE05ParamInfo>> RE_05Report;
        internal void OnRE_05Report(RE05ParamInfo param)
        {
            if (RE_05Report != null)
                RE_05Report(this, new EventArgs<RE05ParamInfo>(param));
        }
