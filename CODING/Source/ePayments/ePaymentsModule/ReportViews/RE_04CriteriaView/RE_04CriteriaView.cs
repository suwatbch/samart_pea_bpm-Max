...
{
    [SmartPart]
    public partial class RE_04CriteriaView : UserControl, IRE_04CriteriaView
    {
        public RE_04CriteriaView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public RE_04CriteriaViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                RE04ParamInfo param = new RE04ParamInfo();
                ...
                _presenter.OnRE_04Report(param);
            }
        }
        ...
        {
            _presenter.LoadAccountClassList(PEA.BPM.ePaymentsModule.Interface.BusinessEntities.Reports.ReportName.RE_04);
        }
        ...
        private void ddlAccountClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                comParam.TargetReport = ReportName.RE_04;
            ...
            catch (Exception ex)
            {
                ...
                Logger.WriteError(Logger.Module.EPAYMENT, "แสดงข้อมูล Company RE_04", ex.ToString());
