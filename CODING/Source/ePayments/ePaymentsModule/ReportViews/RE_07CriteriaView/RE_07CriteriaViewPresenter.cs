...
{
    public class RE_07CriteriaViewPresenter : Presenter<IRE_07CriteriaView>
    {
        /// <summary>
        ...
        [EventPublication(EventTopicNames.RE_07Report, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs<RE07ParamInfo>> Show07ReportHandler;
        public void Show07Report(RE07ParamInfo reportParam)
        {
            if (Show07ReportHandler != null)
            {
                Show07ReportHandler(this, new EventArgs<RE07ParamInfo>(reportParam));
            }
        }
