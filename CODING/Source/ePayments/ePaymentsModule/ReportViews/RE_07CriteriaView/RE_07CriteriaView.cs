...
{
    [SmartPart]
    public partial class RE_07CriteriaView : UserControl, IRE_07CriteriaView
    {
        public RE_07CriteriaView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public RE_07CriteriaViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        {
            _presenter.LoadAccountClassList(PEA.BPM.ePaymentsModule.Interface.BusinessEntities.Reports.ReportName.RE_07);
        }
        ...
        private void ddlAccountClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                comParam.TargetReport = ReportName.RE_07;
            ...
            catch (Exception ex)
            {
                ...
                Logger.WriteError(Logger.Module.EPAYMENT, "แสดงข้อมูล Company RE_07", ex.ToString());
        ...
        private void btnDisplay_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RE07ParamInfo param = new RE07ParamInfo();
                ...
                _presenter.Show07Report(param);

            }
            catch (Exception ex)
            {
                WaitingFormHelper.HideWaitingForm();
                Logger.WriteError(Logger.Module.EPAYMENT, "แสดงรายงาน RE_07", ex.ToString());
                MessageBox.Show("ไม่สามารถติดต่อกับฐานข้อมูลได้ โปรดติดต่อผู้ดูแลระบบ\n", "ข้อผิดพลาด",
                   MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
