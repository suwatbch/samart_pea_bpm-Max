...
namespace PEA.BPM.ePaymentsModule.Interface.BusinessEntities.ReceiptPrinting
{
    ...
    {
        private string w_10_invoice_no = string.Empty;
        private string w_100_sender = string.Empty;
        private string w_110_post_code = string.Empty;
        private string w_121_mailing_person = string.Empty;
        private string w_122_mailing_person = string.Empty;
        private string w_130_period = string.Empty;
        private string w_140_reg = string.Empty;
        private string w_150_contract = string.Empty;
        private string w_160_device = string.Empty;
        private string w_170_rate_cat = string.Empty;
        private string w_171_ettat_code = string.Empty;
        private string w_200_mr_date = string.Empty;
        private string w_211_address = string.Empty;
        private string w_212_address = string.Empty;
        private string w_213_address = string.Empty;
        private string w_241_242_address = string.Empty;
        private string w_243_address = string.Empty;
        private string w_250_post_code = string.Empty;
        private string w_255_device_1 = string.Empty;
        private string w_260_zwstand_1_txt = string.Empty;
        private string w_270_zwstvor_1_txt = string.Empty;
        private string w_280_umwfakt_1_txt = string.Empty;
        private string w_290_abrmenge_1_txt = string.Empty;
        private string w_295_device_2 = string.Empty;
        private string w_300_zwstand_2_txt = string.Empty;
        private string w_310_zwstvor_2_txt = string.Empty;
        private string w_320_umwfakt_2_txt = string.Empty;
        private string w_330_abrmenge_2_txt = string.Empty;
        private string w_340_peak_txt = string.Empty;
        private string w_350_dash_txt = string.Empty;
        private string w_355_device_3 = string.Empty;
        private string w_360_zwstand_3_txt = string.Empty;
        private string w_370_zwstvor_3_txt = string.Empty;
        private string w_380_umwfakt_3_txt = string.Empty;
        private string w_390_abrmenge_3_txt = string.Empty;
        private string w_400_off_peak_txt = string.Empty;
        private string w_410_ene_txt = string.Empty;
        private string w_415_device_4 = string.Empty;
        private string w_420_zwstand_4_txt = string.Empty;
        private string w_430_zwstvor_4_txt = string.Empty;
        private string w_440_umwfakt_4_txt = string.Empty;
        private string w_450_abrmenge_4_txt = string.Empty;
        private string w_460_hol_txt = string.Empty;
        private string w_500_txt6 = string.Empty;
        private string w_1310_amount_txt = string.Empty;
        private string w_1380_fttot_txt = string.Empty;
        private string w_1381_ft_peiod_txt = string.Empty;
        private string w_1400_ftchg_txt = string.Empty;
        private string w_1450_mr_kw_17_6_txt = string.Empty;
        private string w_1460_mr_kw_17_7 = string.Empty;
        private string w_1480_net_before_vat_txt = string.Empty;
        private string w_1490_tax_rate_txt = string.Empty;
        private string w_1500_tax_amount_txt = string.Empty;
        private string w_1510_total_amnt_txt = string.Empty;
        private string w_1550_case_text1 = string.Empty;
        private string w_1550_case_text2 = string.Empty;
        private string w_1550_case_text3 = string.Empty;
        private string w_1550_case_text4 = string.Empty;
        private string w_1570_account_number = string.Empty;
        private string w_1581_bank_due_date = string.Empty;
        private string w_1610_invoice = string.Empty;
        private string w_1620_buss_name = string.Empty;
        private string w_1631_1632_name = string.Empty;
        private string w_1633_name = string.Empty;
        private string w_1640_device_13_l1 = string.Empty;
        private string w_1650_rate_cat_13_l2 = string.Empty;
        private string w_1660_contract_ac_14_l1 = string.Empty;
        private string w_1670_period_15_l1 = string.Empty;
        private string w_1680_mr_date_15_l2 = string.Empty;
        private string w_1690_unit_after_16_l1 = string.Empty;
        private string w_1700_unit_previous_16_l2 = string.Empty;
        private string w_1710_consumption_17_l1 = string.Empty;
        private string w_1720_based_amount_18_l1 = string.Empty;
        private string w_1730_discount_amount_19_l1 = string.Empty;
        private string w_1740_disct_descript = string.Empty;
        private string w_1750_baht = string.Empty;
        private string w_1760_ft_amount_20_l1 = string.Empty;
        private string w_1770_ft_price_20_l2 = string.Empty;
        private string w_1780_net_before_tax_21_l1 = string.Empty;
        private string w_1790_tax_amount_22_l1 = string.Empty;
        private string w_1800_tax_rate_22_l2 = string.Empty;
        private string w_1810_total_value_23_l1 = string.Empty;
        private string w_1820_payment_date_24_l1 = string.Empty;
        private string w_1874_green = string.Empty;
        private string w_1875_green_mass_print = string.Empty;
        private string billSeqNo = string.Empty;
        private string _fixedType = String.Empty;
        private string w_2070_taxid_p = String.Empty;
        private string w_2080_taxid_c = String.Empty;
