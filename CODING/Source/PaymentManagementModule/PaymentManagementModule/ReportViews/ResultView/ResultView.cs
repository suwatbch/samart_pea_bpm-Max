...
namespace PEA.BPM.PaymentManagementModule
{
    ...
    public partial class ResultView : UserControl, IResultView
    {
        ...
        //                e.DataSources.Add(new ReportDataSource("PEA_BPM_PaymentManagementModule_Interface_BusinessEntities_Reports_CAC05Report", newreport));
        //                break;
        //            }
        //        }
        //    }
        ...
        //        int index = report.BinarySearch(new CAC01Report(branchId), new CAC01Report.BranchIdComparer());
        //        List<CAC01Detail> detail = report[index].Detail;
        //        e.DataSources.Add(new ReportDataSource("PEA_BPM_PaymentManagementModule_Interface_BusinessEntities_Reports_CAC01Detail", detail));
        ...
        //        MessageBox.Show(ex.ToString());
        //    }
        //    //e.DataSources.Add(new ReportDataSource("PEA_BPM_PaymentManagementModule_Interface_BusinessEntities_Reports_CAC01Detail", books));
