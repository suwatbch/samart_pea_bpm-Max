...
{
    public class ServerConfigViewPresenter : Presenter<IServerConfigView>
    {
        /// <summary>
        ...
        public ServerConfigViewPresenter([ServiceDependency] IAzManService azManService)
		{
        ...
        public DateTime TestWS(string WSUrl)
        {
            return _azManService.GetWSServerTime(WSUrl);
        }

        public DateTime TestDB(string WSUrl)
        {
            return _azManService.GetDBServerTime(WSUrl);
        }
