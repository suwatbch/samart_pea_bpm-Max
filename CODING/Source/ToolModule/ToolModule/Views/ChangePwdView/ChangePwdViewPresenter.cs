...
{
    public class ChangePwdViewPresenter : Presenter<IChangePwdView>
    {
        /// <summary>
        ...
        public ChangePwdViewPresenter([ServiceDependency] IAzManService azManService)
		{
        ...
        {
            return _azManService.UpdateUser(null, user);
        }
