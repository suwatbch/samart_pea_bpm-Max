...
{
    public class StartOpenBalanceViewPresenter : Presenter<IStartOpenBalanceView>
    {
        private ICashManagementServices _service;
        private ICashReportServices _reportService;

		[InjectionConstructor]
        public StartOpenBalanceViewPresenter([ServiceDependency] ICashManagementServices service,
                                                                 ICashReportServices reportService)
		{
            _service = service;
        ...
        {
            _service.SaveStartOpenBalance(param);
        }

        public List<PaymentMethodInfo> LoadSystemInitial(string workId)
        {
            return _service.LoadSystemInitial(workId);
        }
