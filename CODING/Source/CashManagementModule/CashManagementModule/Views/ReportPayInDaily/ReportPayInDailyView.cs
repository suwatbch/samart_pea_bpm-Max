...
{
    [SmartPart]
    public partial class ReportPayInDailyView : UserControl, IReportPayInDailyView
    {
        #region "Code Generated"

        public ReportPayInDailyView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public ReportPayInDailyViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        private void previewBt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    AvailableDayPayIn ap = new AvailableDayPayIn();
                    List<ReportAvailableInfo> aviList = _presenter.GetAvailablePayInList(param);
