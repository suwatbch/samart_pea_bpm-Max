...
{
    public class AutoCompleteTextBoxExtended<T> : TextBox where T : IListItem
    {
        ...
        private IAdjustOpenBalanceView _view;

        public AutoCompleteTextBoxExtended(System.Windows.Forms.Control replacedControl, AdjustOpenBalanceView view)
        {
            ...
            {
                AutoCompleteTextBoxExtended<T> actb = (AutoCompleteTextBoxExtended<T>)replacedControl.Tag;
                actb.Dispose();
        ...
        public static T GetSelectedItem(System.Windows.Forms.Control replacedControl)
        {
            ...
            if (o != null)
            {
                AutoCompleteTextBoxExtended<T> actb = (AutoCompleteTextBoxExtended<T>)o;
                ...
                switch (e.KeyCode)
                {
                    ...
                    case Keys.Enter:
                        if (_listBox.SelectedIndex > -1)
                        {
                            ...
                            //trigger
                            _view.LoadCashier(_selectedItem.DisplayText);
                            _popupable = true;
                            e.SuppressKeyPress = true;
                        }
                        break;
