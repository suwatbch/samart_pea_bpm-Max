...
{
    public class RemeterViewPresenter : Presenter<IRemeterView>
    {
        private IBillingService _billingService;       

        [InjectionConstructor]
        public RemeterViewPresenter([ServiceDependency] IBillingService billingService)
		{
        ...
        //{
        //    //View.CaId = e.Data;
        //    string[] st = e.Data.Split('|');
        //    View.disconnectStrLine = st[0];
        //    View.reconnectStrLine = st[1];
        //    ShowView();
        //}
        ...
        internal LastDisconnect GetLastDisconnectByCaId(string caId)
        {
            return _billingService.GetLastDisconnect(caId);
        }
