...
{
    public class ReceiptSearchViewPresenter : Presenter<IReceiptSearchView>
    {
        /// <summary>
        ...
        [EventPublication(EventTopicNames.ReceiptSearch, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs> ReceiptSearch;
        internal void OnReceiptSearch(ReceiptSearchParam param)
        {
            if (ReceiptSearch != null)
                ReceiptSearch(this, new EventArgs<ReceiptSearchParam>(param));
        }
