...
{
    public class CAC15CriteriaViewPresenter : Presenter<ICAC15CriteriaView>
    {
        public IBillingService _billingService;
        
		[InjectionConstructor]
        public CAC15CriteriaViewPresenter([ServiceDependency] IBillingService billingService)
		{
        ...
        internal void OnShowReport(CAC15Param param)
        {
            if (ShowReport != null)
