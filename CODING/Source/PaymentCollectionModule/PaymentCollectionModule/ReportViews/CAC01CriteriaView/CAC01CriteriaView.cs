...
{
    [SmartPart]
    public partial class CAC01CriteriaView : UserControl, ICAC01CriteriaView
    {
        public CAC01CriteriaView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public CAC01CriteriaViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        private void displayReport()
        {
            ...
            {
                param.Report = ReportName.CAC01_1;
            }
            else if (detailReportRadioButton.Checked == true)
            {
                param.Report = ReportName.CAC01_2;
            }
