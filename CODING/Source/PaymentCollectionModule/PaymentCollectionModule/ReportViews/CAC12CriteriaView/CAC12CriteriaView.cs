...
{
    [SmartPart]
    public partial class CAC12CriteriaView : UserControl, ICAC12CriteriaView
    {
        public CAC12CriteriaView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public CAC12CriteriaViewPresenter Presenter
        {
            set
            {
                _presenter = value;
