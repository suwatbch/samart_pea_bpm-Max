...
{
    [SmartPart]
    public partial class CAC07CriteriaView : UserControl, ICAC07CriteriaView
    {
        public CAC07CriteriaView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public CAC07CriteriaViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        private void displayReport()
        {
            ...
            if (branchIdSortingRadioButton.Checked == true)
            {
                param.Report = ReportName.CAC07_1;
            }
            else if (controllerSortingRadioButton.Checked == true)
            {
                param.Report = ReportName.CAC07_2;
            }
