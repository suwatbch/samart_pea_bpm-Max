...
{
    [SmartPart]
    public partial class CAC05CriteriaView : UserControl, ICAC05CriteriaView
    {
        private ValidatePaymentActive vpa = new ValidatePaymentActive();

        public CAC05CriteriaView()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        [CreateNew]
        public CAC05CriteriaViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        private void displayReport()
        {
            ...
            {
                param.Report = ReportName.CAC05_1;
            }
            else if (detailReportRadioButton.Checked == true)
            {
                param.Report = ReportName.CAC05_2;
            }
