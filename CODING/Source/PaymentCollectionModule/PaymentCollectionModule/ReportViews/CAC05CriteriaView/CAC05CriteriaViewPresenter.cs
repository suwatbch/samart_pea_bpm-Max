...
{
    public class CAC05CriteriaViewPresenter : Presenter<ICAC05CriteriaView>
    {
        public IBillingService _billingService;
        
		[InjectionConstructor]
        public CAC05CriteriaViewPresenter([ServiceDependency] IBillingService billingService)
		{
        ...
        internal void OnShowReport(CAC06Param param)
        {
            if (ShowReport != null)
