...
{
    public class CAC16CriteriaViewPresenter : Presenter<ICAC16CriteriaView>
    {
        public IBillingService _billingService;
        
		[InjectionConstructor]
        public CAC16CriteriaViewPresenter([ServiceDependency] IBillingService billingService)
		{
        ...
        internal void OnShowReport(CAC16Param param)
        {
            if (ShowReport != null)
