...
{
    public class GroupInvoiceViewPresenter : Presenter<IGroupInvoiceView>
    {
        private IControlServices _controlServices;

        [InjectionConstructor]
        public GroupInvoiceViewPresenter([ServiceDependency] IControlServices controlServices)
        {
            _controlServices = controlServices;
        }

        [EventPublication(EventTopicNames.PrintGroupInvoice, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs<GroupInvoiceParam>> PrintGroupInvoice;
        public void PrintGroupInvoiceWithoutCoverPage(GroupInvoiceParam param)
        {
            if (PrintGroupInvoice != null)
                PrintGroupInvoice(this, new EventArgs<GroupInvoiceParam>(param));
        }
        ...
        [EventSubscription(EventTopicNames.GrpInvAvailableBillCount, Thread = ThreadOption.UserInterface)]
        public void GrpInvAvailableBillCountHandler(object sender, EventArgs<int> e)
        {
            View.AvailableBillCount = e.Data;
        }
