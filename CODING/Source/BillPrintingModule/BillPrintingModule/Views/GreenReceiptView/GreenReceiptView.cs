...
{
    [SmartPart]
    public partial class GreenReceiptView : UserControl, IGreenReceiptView
    {
        ...
        /// </summary>
        [CreateNew]
        public GreenReceiptViewPresenter Presenter
        {
            set
            {
                _presenter = value;
        ...
        private void Print()
        {
            if (ValidateBeforeSubmit())
            {
                ...
                //{
                    ...
                    param.BillType = (int)BillType.GreenReceipt;
                    ...
                    _presenter.SearchGreenReceipt(param);
                    this.Cursor = Cursors.Default;
                //}
            }            
        }
        ...
        private void AddToDataGridView(string txt)
        {
            ...
            if (isRepeatedItem == false)
            {
                try
                {
                    ...
                    for (int j = 0; j <= i - 1; j++)
                    {
                        dualBillDataGridView.Rows[j].Selected = false;
                    }
                }
                catch (Exception ex)
                {
