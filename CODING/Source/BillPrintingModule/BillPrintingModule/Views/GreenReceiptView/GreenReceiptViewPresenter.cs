...
{
    public class GreenReceiptViewPresenter : Presenter<IGreenReceiptView>
    {
        private IControlServices _controlServices;
        
        [InjectionConstructor]
        public GreenReceiptViewPresenter([ServiceDependency] IControlServices controlServices)
		{
            _controlServices = controlServices;
		}

        [EventPublication(EventTopicNames.PrintGreenReceipt, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs<BillPrintingConditionParam>> PrintGreenReceipt;
        public void SearchGreenReceipt(BillPrintingConditionParam param)
        {
            if (PrintGreenReceipt != null)
                PrintGreenReceipt(this, new EventArgs<BillPrintingConditionParam>(param));
        }
