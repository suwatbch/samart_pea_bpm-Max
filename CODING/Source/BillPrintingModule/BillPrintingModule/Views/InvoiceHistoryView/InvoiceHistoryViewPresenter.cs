...
{
    public class InvoiceHistoryViewPresenter : Presenter<IInvoiceHistoryView>
    {
        private IControlServices _controlServices;

        [InjectionConstructor]
        public InvoiceHistoryViewPresenter([ServiceDependency] IControlServices controlServices)
		{
        ...
        {
            return _controlServices.GetContractAccountHistory(caId, printBranch);
        }
