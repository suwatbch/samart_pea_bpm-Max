...
{
    public class DualBillViewPresenter : Presenter<IDualBillView>
    {
        private IControlServices _controlServices;
        
        [InjectionConstructor]
        public DualBillViewPresenter([ServiceDependency] IControlServices controlServices)
		{
            _controlServices = controlServices;
		}

        [EventPublication(EventTopicNames.PrintDualBill, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs<BillPrintingConditionParam>> PrintDualBill;
        public void PrintDualBillAndReceipt(BillPrintingConditionParam param)
        {
            if (PrintDualBill != null)
                PrintDualBill(this, new EventArgs<BillPrintingConditionParam>(param));
        }
