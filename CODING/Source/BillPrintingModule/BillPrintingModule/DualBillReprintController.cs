...
{
    public class DualBillReprintController : WorkItemController
    {
        private ILayoutService _layoutService;

        [InjectionConstructor]
        public DualBillReprintController([ServiceDependency] ILayoutService layoutService)
        {
        ...
        public override void Run()
        {
            try
            {
                ...
                CloseAllViews();
                DualBillReprintView sView;
                SetWindowsTitle(Properties.Resources.DualBillReprint);
                if (WorkItem.Items.Contains("IDualBillReprintView"))
                {
                    sView = WorkItem.Items.Get<DualBillReprintView>("IDualBillReprintView");
                }
                else
                {
                    sView = WorkItem.Items.AddNew<DualBillReprintView>("IDualBillReprintView");
                }
